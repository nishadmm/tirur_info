...
<body>
  ...
  <div class="mob-drop-down">
    ...
    <li><a href="#">
          ...
          </div> Logout <i class="fas fa-angle-down"></i>
        </a>
        <ul>
  ...
  <div class="profile-grid dark-text">
    <div class="side-menu">
      ...
      <a href="profile_logout.php" class="side-selected">LogOut <i class="fas fa-user-slash"></i></a>
    </div>
    <div class="signin-form logout-form">
      <h2 class="center primary-head pb-1 logout-msg">
        <?php echo $msg; ?>
      </h2>
      <div class="logout-box box-shadow mbt-3 center">
        <span class="logout-cancel"><a href="profile_profile.php"><span id="x">X</span></a></span>
        <div class="logout-content">
          <h1 class="pb-1 uppercase">Logout <i class="fas fa-sign-in-alt"></i></h1>
          <div class="bottom-line"></div>
          <p class="mbt-1">Are You Sure ?</p>
          <form action="" method="POST">
            <div class=" logout-btns ">
              <a href="profile_profile.php" class="btns">No &#10008;</a>
              <input type="submit" name="logout" class="btns" value="Yes &#10004;">
            </div>
          </form>
          <div>
            <p class="lead center mbt-1 form-link">See All shop in Tirur ? <a href="profile_report.php"> Click here</a>
            </p>
          </div>
        </div>
      </div>
