...
if(isset($_POST['update'])) {
  ...
  if(strlen($mobile) != '10') {
    ...
    $sql2= "update shoptable set shopname = '".$_POST['shopname']."',shopcategory='".$_POST['shopcategory']."',location='".$_POST['location']."',mobile='".$_POST['mobile']."' where shop_id='".$id."'";
...
<body>
  ...
  <!-- section b -->
   ...
   <div class="mob-drop-down">
    ...
    <li><a href="#">
          <div class="show-us">
            <?php echo $user1; ?>
          </div> Update <i class="fas fa-angle-down"></i>
        </a>
        <ul>
  ...
  <div class="profile-grid dark-text">
    <div class="side-menu">
      ...
      <a href="profile_update.php" class="side-selected">Update <i class="fas fa-pen-square"></i></a>
    ...
    <div class="signin-form update-form">
      <div class="form-container box-shadow">
        <h2 class="center uppercase pbt-1"> <i class="fas fa-pencil-alt"></i> Update <span class="primary-head"> Your
            data</span></h2>
        <div class="bottom-line"></div>
        <div class="profile-view">

          <form action="profile_update.php" method="POST" class=" update-form" id="register-form" name="registration">
            <div class="input-container">
              <label>Shop Name</label>
              <input class="profile-input" type="text" name="shopname" required value="<?php echo $shopname;?>">
            </div>
            <div class="input-container">
              <label>Select Shop Category</label>
              <select name="shopcategory">
                <option value="<?php echo $shopcategory;?>">
            ...
            <div class="input-container">
              ...
              <input class="profile-input" type="number" name="mobile" required value="<?php echo $mobile;?>">
            ...
            <div class="input-container two-btn">
              ...
              <input type="submit" name="update" class="update-btn btn" value="Update &#10004;">
            </div>
          </form>
        </div>
        <div>
