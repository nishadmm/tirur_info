...
<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //  Empty checking
		if ( empty($_POST["username"]) || empty($_POST["password"]) || empty($_POST["location"]) || empty($_POST["mobile"])) {
...
<body>
  ...
  <div class="profile-grid dark-text">
    ...
    <div class="signin-form without-shop">
      <div class="form-container box-shadow">
        <h2 class="center uppercase pbt-1"><i class="fas fa-scroll"></i> registration <span class="primary-head"> form
            without shop</span></h2>
        <div class="bottom-line"></div>
        <p class="center pbt-1 lead signin-lead form-link">You have Shop ? <a href="profile_signin.php">SignUp with
            shop</a></p>

        <!-- Form -->
        <form action="profile_signup_noshop.php" method="POST" id="reg-form">
          ...
          <input type="submit" name="submit" class="profile-btn" value="Register &#9930;">
        </form>
        <div>
